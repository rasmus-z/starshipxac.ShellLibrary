...
namespace starshipxac.Windows.Shell.Dialogs.Interop
{
    ...
    /// </summary>
    /// <remarks>
    /// http://msdn.microsoft.com/en-us/library/windows/desktop/bb775834(v=vs.85).aspx
    /// </remarks>
    [ComImport]
    [Guid(ShellIID.IFileOpenDialog)]
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    internal interface IFileOpenDialog : IFileDialog2
    {
#pragma warning disable 0108
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void SetFileTypes([In] UInt32 cFileTypes, [In] ref COMDLG_FILTERSPEC rgFilterSpec);
