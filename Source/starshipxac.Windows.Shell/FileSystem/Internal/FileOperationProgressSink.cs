...
namespace starshipxac.Windows.Shell.FileSystem.Internal
{
	internal class FileOperationProgressSink : IFileOperationProgressSink
	{
		...
		public HRESULT PostCopyItem(uint dwFlags, IShellItem psiItem, IShellItem psiDestinationFolder, string pszNewName, HRESULT hrCopy,
		...
		public HRESULT PostMoveItem(uint dwFlags, IShellItem psiItem, IShellItem psiDestinationFolder, string pszNewName, HRESULT hrMove,
			IShellItem psiNewlyCreated)
		{
		...
		public HRESULT PostRenameItem(uint dwFlags, IShellItem psiItem, string pszNewName, HRESULT hrRename, IShellItem psiNewlyCreated)
		{
