...
namespace starshipxac.Shell.Interop
{
    ...
    ///     <see cref="IShellItem.GetDisplayName(SIGDN, out string)"/>.
    /// </summary>
    /// <remarks>
    ...
    internal enum SIGDN
    {
        ...
        ///     Only items that report <see cref="SFGAO.SFGAO_FILESYSTEM"/> have a file system path.
        ///     When an item does not have a file system path, a call to <see cref="IShellItem.GetDisplayName(SIGDN, out string)"/> on that item will fail.
        ...
        ///     Some items do not have a URL, and in those cases a call to <see cref="IShellItem.GetDisplayName(SIGDN, out string)"/> will fail.
