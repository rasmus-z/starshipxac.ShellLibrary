...
namespace starshipxac.Shell
{
	...
	public sealed class ShellItem : IEquatable<ShellItem>
	{
		...
		/// 取得したいフラグのみを<param name="mask"/>に指定してください。
		/// </pre>
		/// </remarks>
		...
		public bool Equals(ShellItem other)
		{
			...
			int order;
			var hr = this.ShellItemInterface.Compare(other.ShellItemInterface, SICHINTF.SICHINT_TEST_FILESYSPATH_IF_NOT_EQUAL, out order);
