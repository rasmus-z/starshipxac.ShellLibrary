...
namespace starshipxac.Shell.Search
{
	public static class SearchConditionFactory
	{
		...
		public static SearchCondition CreateLeafCondition(ShellPropertyKey propertyKey, string value, SearchConditionOperation operation)
		{
		...
		public static SearchCondition CreateLeafCondition(ShellPropertyKey propertyKey, bool value, SearchConditionOperation operation)
		{
			Contract.Requires<ArgumentNullException>(propertyKey != null);
		...
		public static SearchCondition CreateLeafCondition(ShellPropertyKey propertyKey, double value, SearchConditionOperation operation)
		{
			Contract.Requires<ArgumentNullException>(propertyKey != null);
		...
		public static SearchCondition CreateLeafCondition(ShellPropertyKey propertyKey, int value, SearchConditionOperation operation)
		{
			Contract.Requires<ArgumentNullException>(propertyKey != null);
