...
namespace TaskDialogSample.Views
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public DispatcherOperation ShowSimpleTaskDialogAsync()
        {
        ...
        public DispatcherOperation ShowAllControlsTaskDialogAsync()
        {
            return this.Dispatcher.InvokeAsync(() =>
            {
                using (var taskDialog = new TaskDialog())
        ...
        public DispatcherOperation ShowCustomButtonTaskDialogAsync()
        {
            return this.Dispatcher.InvokeAsync(() =>
            {
                using (var taskDialog = new TaskDialog())
        ...
        public DispatcherOperation ShowCommandLinkTaskDialogAsync()
        {
            return this.Dispatcher.InvokeAsync(() =>
            {
                using (var taskDialog = new TaskDialog())
        ...
        public DispatcherOperation ShowRadioButtonTaskDialogAsync()
        {
            return this.Dispatcher.InvokeAsync(() =>
            {
                using (var taskDialog = new TaskDialog())
        ...
        public DispatcherOperation ShowMarqueeTaskDialogAsync()
        {
            return  this.Dispatcher.InvokeAsync(() =>
            {
                using (var taskDialog = new TaskDialog())
